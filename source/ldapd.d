...
extern(C)
{
    int strncasecmp_l(const(char)*, const(char)*, size_t, __locale_struct*) @nogc nothrow;
    ...
    size_t strlen(const(char)*) @nogc nothrow;
    ...
    size_t strspn(const(char)*, const(char)*) @nogc nothrow;
    size_t strcspn(const(char)*, const(char)*) @nogc nothrow;
    ...
    size_t strxfrm_l(char*, const(char)*, size_t, __locale_struct*) @nogc nothrow;
    int strcoll_l(const(char)*, const(char)*, __locale_struct*) @nogc nothrow;
    size_t strxfrm(char*, const(char)*, size_t) @nogc nothrow;
    ...
    int ldap_ntlm_bind(ldap*, const(char)*, size_t, berval*, ldapcontrol**, ldapcontrol**, int*) @nogc nothrow;
    ...
    alias BER_MEMALLOC_FN = void* function(size_t, void*);
    alias BER_MEMCALLOC_FN = void* function(size_t, size_t, void*);
    alias BER_MEMREALLOC_FN = void* function(void*, size_t, void*);
    alias BER_MEMFREE_FN = void function(void*, void*);
    alias BerMemoryFunctions = lber_memory_fns;
    struct lber_memory_fns
    {
        void* function(size_t, void*) bmf_malloc;
        void* function(size_t, size_t, void*) bmf_calloc;
        void* function(void*, size_t, void*) bmf_realloc;
    ...
    struct sockbuf_io
    {
        ...
        c_long function(sockbuf_io_desc*, void*, size_t) sbi_read;
        c_long function(sockbuf_io_desc*, void*, size_t) sbi_write;
    ...
    void ber_bprint(const(char)*, size_t) @nogc nothrow;
    void ber_dump(berelement*, int) @nogc nothrow;
    alias BERDecodeCallback = int function(berelement*, void*, int);
    size_t ber_get_tag(berelement*) @nogc nothrow;
    size_t ber_skip_tag(berelement*, size_t*) @nogc nothrow;
    size_t ber_peek_tag(berelement*, size_t*) @nogc nothrow;
    size_t ber_skip_element(berelement*, berval*) @nogc nothrow;
    size_t ber_peek_element(const(berelement)*, berval*) @nogc nothrow;
    size_t ber_get_int(berelement*, int*) @nogc nothrow;
    size_t ber_get_enum(berelement*, int*) @nogc nothrow;
    size_t ber_get_stringb(berelement*, char*, size_t*) @nogc nothrow;
    size_t ber_get_stringbv(berelement*, berval*, int) @nogc nothrow;
    size_t ber_get_stringa(berelement*, char**) @nogc nothrow;
    size_t ber_get_stringal(berelement*, berval**) @nogc nothrow;
    size_t ber_get_bitstringa(berelement*, char**, size_t*) @nogc nothrow;
    size_t ber_get_null(berelement*) @nogc nothrow;
    size_t ber_get_boolean(berelement*, int*) @nogc nothrow;
    size_t ber_first_element(berelement*, size_t*, char**) @nogc nothrow;
    size_t ber_next_element(berelement*, size_t*, const(char)*) @nogc nothrow;
    size_t ber_scanf(berelement*, const(char)*, ...) @nogc nothrow;
    ...
    int ber_put_enum(berelement*, int, size_t) @nogc nothrow;
    int ber_put_int(berelement*, int, size_t) @nogc nothrow;
    int ber_put_ostring(berelement*, const(char)*, size_t, size_t) @nogc nothrow;
    int ber_put_berval(berelement*, berval*, size_t) @nogc nothrow;
    int ber_put_string(berelement*, const(char)*, size_t) @nogc nothrow;
    int ber_put_bitstring(berelement*, const(char)*, size_t, size_t) @nogc nothrow;
    int ber_put_null(berelement*, size_t) @nogc nothrow;
    int ber_put_boolean(berelement*, int, size_t) @nogc nothrow;
    int ber_start_seq(berelement*, size_t) @nogc nothrow;
    int ber_start_set(berelement*, size_t) @nogc nothrow;
    ...
    c_long ber_skip_data(berelement*, size_t) @nogc nothrow;
    c_long ber_read(berelement*, char*, size_t) @nogc nothrow;
    c_long ber_write(berelement*, const(char)*, size_t, int) @nogc nothrow;
    ...
    size_t ber_get_next(sockbuf*, size_t*, berelement*) @nogc nothrow;
    ...
    void* ber_memalloc(size_t) @nogc nothrow;
    void* ber_memrealloc(void*, size_t) @nogc nothrow;
    void* ber_memcalloc(size_t, size_t) @nogc nothrow;
    ...
    berval* ber_mem2bv(const(char)*, size_t, int, berval*) @nogc nothrow;
    berval* ber_str2bv(const(char)*, size_t, int, berval*) @nogc nothrow;
    int ldap_is_ldap_url(const(char)*) @nogc nothrow;
    char* ber_strdup(const(char)*) @nogc nothrow;
    size_t ber_strnlen(const(char)*, size_t) @nogc nothrow;
    char* ber_strndup(const(char)*, size_t) @nogc nothrow;
    ...
    alias ber_tag_t = size_t;
    alias ber_socket_t = int;
    alias ber_len_t = size_t;
    alias ber_slen_t = c_long;
    void ldap_memfree(void*) @nogc nothrow;
    void* ldap_memcalloc(size_t, size_t) @nogc nothrow;
    void* ldap_memrealloc(void*, size_t) @nogc nothrow;
    void* ldap_memalloc(size_t) @nogc nothrow;
    ...
    int ldap_set_rebind_proc(ldap*, int function(ldap*, const(char)*, size_t, int, void*), void*) @nogc nothrow;
    alias LDAP_REBIND_PROC = int function(ldap*, const(char)*, size_t, int, void*);
